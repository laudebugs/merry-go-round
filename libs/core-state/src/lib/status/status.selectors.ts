...
export const getStatusState = createFeatureSelector<StatusPartialState, State>(
  STATUS_FEATURE_KEY
);
...
export const getAllStatus = createSelector(getStatusState, (state: State) =>
  selectAll(state)
);
...
export const getSelectedStatusId = createSelector(
  getStatusState,
